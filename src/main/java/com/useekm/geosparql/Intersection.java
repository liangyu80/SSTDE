...
/**
 * Computes a geometry representing the points shared by both passed geometries.
 */
public class Intersection extends AbstractBinaryFunction {
    @Override protected String getName() {
        return "intersection";
    }

    @Override protected Value evaluate(ValueFactory valueFactory, Geometry geom1, Geometry geom2, Value... allArgs) {
        GeoWkt result = new GeoWkt(geom1.intersection(geom2));

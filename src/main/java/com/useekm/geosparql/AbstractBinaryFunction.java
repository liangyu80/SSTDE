...
public abstract class AbstractBinaryFunction extends AbstractFunction {
    protected abstract Value evaluate(ValueFactory valueFactory, Geometry geom1, Geometry geom2, Value... allArgs) throws ValueExprEvaluationException;
    ...
    @Override public Value evaluate(ValueFactory valueFactory, Value... args) throws ValueExprEvaluationException {
        if (args.length < 2)
            ...
            return evaluate(valueFactory, geom1, geom2, args);
        }
    }
}